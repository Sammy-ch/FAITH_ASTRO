...
function PieHalf() {
          ...
          series: [
            {
              ...
              data: [
                { value: 34273, name: "Enfants exposées aux situations d'abus et autres violences ont bénéficié d'un accompagnement psychosocial et suivi à travers des \n visites hebdomadaires et au niveau de nos centres " },
                { value: 3456 , name: "Enfants retirés des situations dangereuses (situations de rues, vie dans les immondices, et des réseaux d'exploitation sexuel, littoral du lac Tanganyika etc.) \n ont reçus ont été réintégré à l'école/ ou en formation professionnelle " },
  ...
  return (
      ...
      <h3 className="text-center">116 416 enfants bénéficiaires des services adéquats de protection dont :</h3>
          <EChartsReact style={{
              height:"100vh"
